...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "ir.supergram.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "ir.supergram.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "ir.supergram.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "ir.supergram.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "ir.supergram.android.musicplayer.next";
