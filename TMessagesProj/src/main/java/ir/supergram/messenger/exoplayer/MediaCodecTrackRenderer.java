 ...
 */
package ir.supergram.messenger.exoplayer;

import ir.supergram.messenger.exoplayer.MediaCodecUtil.DecoderQueryException;
import ir.supergram.messenger.exoplayer.drm.DrmInitData;
import ir.supergram.messenger.exoplayer.drm.DrmSessionManager;
import ir.supergram.messenger.exoplayer.util.Assertions;
import ir.supergram.messenger.exoplayer.util.NalUnitUtil;
import ir.supergram.messenger.exoplayer.util.TraceUtil;
...
public abstract class MediaCodecTrackRenderer extends SampleSourceTrackRenderer {
  ...
  public static class DecoderInitializationException extends Exception {
    ...
    private static String buildCustomDiagnosticInfo(int errorCode) {
      ...
      return "ir.supergram.messenger.exoplayer.MediaCodecTrackRenderer_" + sign + Math.abs(errorCode);
    }
