 ...
 */
package ir.supergram.messenger.exoplayer.text;

import ir.supergram.messenger.exoplayer.ExoPlaybackException;
...
import ir.supergram.messenger.exoplayer.SampleSourceTrackRenderer;
 ...
 *
 * <ul>
 * <li>WebVTT ({@link ir.supergram.messenger.exoplayer.text.webvtt.WebvttParser})</li>
 * <li>TTML
 * ({@link ir.supergram.messenger.exoplayer.text.ttml.TtmlParser})</li>
 * <li>SubRip
 * ({@link ir.supergram.messenger.exoplayer.text.subrip.SubripParser})</li>
 * <li>TX3G
 * ({@link ir.supergram.messenger.exoplayer.text.tx3g.Tx3gParser})</li>
 * </ul>
 *
  ...
  static {
    ...
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("ir.supergram.messenger.exoplayer.text.webvtt.WebvttParser")
    ...
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("ir.supergram.messenger.exoplayer.text.ttml.TtmlParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("ir.supergram.messenger.exoplayer.text.webvtt.Mp4WebvttParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("ir.supergram.messenger.exoplayer.text.subrip.SubripParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("ir.supergram.messenger.exoplayer.text.tx3g.Tx3gParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
