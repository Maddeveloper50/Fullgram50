...
static const char *NativeByteBufferClassPathName = "ir/supergram/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "ir/supergram/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILir/supergram/tgnet/RequestDelegateInternal;Lir/supergram/tgnet/QuickAckDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("ir/supergram/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("ir/supergram/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("ir/supergram/tgnet/ConnectionsManager"));
